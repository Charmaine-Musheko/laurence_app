...
import 'package:laurence_app/pages/OrderPlacePage.dart';
                    ...
                    RaisedButton(
                      onPressed: () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => OrderPlacePage()));
                      },
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              createPriceItem("Total MRP", getFormattedCurrency(51), Colors.grey.shade700),
              createPriceItem("Bag discount", getFormattedCurrency(32), Colors.teal.shade300),
              createPriceItem("Tax", getFormattedCurrency(96), Colors.grey.shade700),
              createPriceItem("Order Total", getFormattedCurrency(20), Colors.grey.shade700),
