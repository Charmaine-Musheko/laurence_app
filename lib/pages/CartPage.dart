            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: Colors.green,
                    image: DecorationImage(image: AssetImage("assets/hawai pizza.png"))),
              ),
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Text(
                          "Hawaiian Pizza','Dough topped with tomato sauce, shredded mozzarella ",
                          maxLines: 2,
                          softWrap: true,
                          style: CustomTextStyle.textFormFieldSemiBold.copyWith(fontSize: 14),
                        ),
                      ),
                      Utils.getSizedBox(height: 6, width:10),
                      Text(
                        "Green M",
