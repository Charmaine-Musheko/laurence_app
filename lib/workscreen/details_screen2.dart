...
class DetailReadScreen2 extends StatefulWidget {
  @override
  State<DetailReadScreen2> createState() => _DetailReadScreenState();


}

class _DetailReadScreenState extends State<DetailReadScreen2> {
