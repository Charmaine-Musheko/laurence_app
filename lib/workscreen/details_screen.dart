...
class DetailReadScreen extends StatefulWidget {
  @override
  State<DetailReadScreen> createState() => _DetailReadScreenState();


}

class _DetailReadScreenState extends State<DetailReadScreen> {
