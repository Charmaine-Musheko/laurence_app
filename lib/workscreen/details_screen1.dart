...
class DetailReadScreen1 extends StatefulWidget {
  @override
  State<DetailReadScreen1> createState() => _DetailReadScreenState();


}

class _DetailReadScreenState extends State<DetailReadScreen1> {
