  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: Container(
          ...
          child: ListView(
            // itemCount: _banking.length,
            // itemBuilder: (context, index) {
            // Banking bankDetails = _banking[index];
            children:
            <Widget>[
              SizedBox(
                height: 32.0,
                    ...
                    Column(
                      children: <Widget>[
                        ...
                        Text(
                          '\$4373.23',
                          style:
                          TextStyle(fontSize: 22.0, fontWeight: FontWeight
                              .w500),
                        ),
                      ],
                    )
                ...
                child:  Card(
                  child: Column(
                    children: <Widget>[
                      ...
                      ValueCard('Bank America', '\$ 64.00', '12-03-2019',
                        'DBBL - City bank',),
                      ValueCard('Bank America', '\$ 6532.21', '12-03-2019',
                        'DBBL - City bank',),
                      ValueCard('Bank America', '\$ 258.00', '12-03-2019',
                        'DBBL - City bank',),
                      ValueCard('Bank America', '\$ 533.20', '12-03-2019',
                        'DBBL - City bank',),
                      ValueCard('Bank America', '\$ 3335', '12-03-2019',
                        'DBBL - City bank',),
                      ValueCard('Bank America', '\$ 520', '12-03-2019',
                        'DBBL - City bank',),
                    ],
                  ),
                ),
