...
class DetailReadScreen3 extends StatefulWidget {
  @override
  State<DetailReadScreen3> createState() => _DetailReadScreenState();


}

class _DetailReadScreenState extends State<DetailReadScreen3> {
